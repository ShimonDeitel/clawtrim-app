    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Legal") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/clawtrim-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/clawtrim-app/terms.html")!)
                }
            }
